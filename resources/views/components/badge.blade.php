...
@php
    $classes = [
        'navy'   => 'bg-uni-purple-100 text-uni-purple-700 border-uni-purple-200',
        'gold'   => 'bg-uni-gold-100 text-uni-gold-700 border-uni-gold-200',
        /* Legacy aliases — map old keys to accessible variants */
        'purple' => 'bg-uni-purple-100 text-uni-purple-700 border-uni-purple-200',
    ...
    ][$type] ?? 'bg-uni-purple-100 text-uni-purple-700 border-uni-purple-200';
@endphp
